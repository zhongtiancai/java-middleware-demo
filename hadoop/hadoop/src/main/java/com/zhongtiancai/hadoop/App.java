package com.zhongtiancai.hadoop;
...
public class App {
	...
	Mapper<LongWritable, Text, Text, IntWritable> {
		...
		throws IOException, InterruptedException {
			...
			int temperature=0;
			if('+' == line.charAt(45)) {
	            temperature = Integer.parseInt(line.substring(46, 50));
	        } else {
	            temperature = Integer.parseInt(line.substring(45, 50));
	        }
